 ...
 *
 * Description: Alter scrolling speed by changing Move_Delay function
*/
...
char txt1[] = "Skylar Grant"; //create char arrays, symbol enclosed by quotation marks
char txt2[] = "ETC220";
char txt3[] = "MicroApplication";
char txt4[] = "I Love to Code";
char i; //Loop variable "i" created

void Move_Delay()
{                //Create function called "Move_Delay" called later in code
  Delay_ms(100); //Delay settings changed within function
}
